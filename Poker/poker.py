...
credit= random.randrange(1, 50)
strength = random.randrange(1, 50)
num_plays = random.randrange(1, 50)
print(credit, strength, num_plays)

money_tally = play_poker(money=credit, sim_strength=strength, max_count=num_plays, verbose=False)
print(money_tally)
